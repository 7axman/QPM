...
The original project was published without an explicit license (All Rights Reserved by default). As such, this fork is intended strictly for personal, private use on macOS to resolve interface binding and modern qBittorrent cookie compatibility issues. No explicit open-source license is provided.
